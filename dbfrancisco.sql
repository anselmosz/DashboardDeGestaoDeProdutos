...
-- CRIANDO A TABELA DE VOLUNTARIOS
...
VALUES('Giovanne Silveira','1194513-8385','474.563.448-09','03905-050','Joao Batista Lima','327','','Jd.Aricanduva','Sao Paulo','SP');
...
-- VoluntArio 2
INSERT INTO tbVoluntarios(nome,telCel,cpf,cep,rua,numero,complemento,bairro,cidade,estado)
VALUES('Mariana Oliveira','1198765-4422','512.449.987-33','04567-020','Rua das Rosas','120','','Jardim Paulista','Sao Paulo','SP'); 
...
-- VoluntArio 3
INSERT INTO tbVoluntarios(nome,telCel,cpf,cep,rua,numero,complemento,bairro,cidade,estado)
VALUES('Carlos Eduardo Santos','1195544-3321','398.772.125-80','05843-210','Av. Dom Pedro II','450','Bloco B','Capao Redondo','Sao Paulo','SP'); 
...
-- VoluntArio 4
INSERT INTO tbVoluntarios(nome,telCel,cpf,cep,rua,numero,complemento,bairro,cidade,estado)
VALUES('Fernanda Costa','1199944-7788','217.845.660-40','07012-310','Rua Antonio Dias','89','','Vila Galvao','Guarulhos','SP'); 
...
-- VoluntArio 5
INSERT INTO tbVoluntarios(nome,telCel,cpf,cep,rua,numero,complemento,bairro,cidade,estado)
VALUES('Ricardo Mendes','1196112-9090','330.998.471-12','04082-020','Rua Estrela do Norte','310','Apto 22','Vila Mariana','Sao Paulo','SP'); 

INSERT INTO tbUsuarios(email,senha,tipo,salt,codVol)
VALUES('ricardo.mendes@email.com','123456789','Comum','258963147','5');

-- Consulta para atualizar os dados do grAfico de produtos referente aos ultimos itens adicionados e sua quantidade
...
-- Consulta  ultimos itens adicionados ao banco, incluindo quem cadastrou, quando e o que
...
-- Consulta de dados mensais (quantidade de produtos doados por mes durante o ano)
...
-- Consulta para referencia de qual e o mes atual
...
-- Consultas para atualizar os dados de total referentes ao me vigente
...
-- realiza consulta de itens com base num periodo especifico da data de entrada
...
-- Realiza a consulta dos dados especificos da tabela de usuArios e voluntArios por meio de um inner join
-- SELECT usr.email AS 'Email do Voluntario', vol.nome AS 'Nome do voluntario', vol.telCel AS 'Telefone', CONCAT(vol.rua, ' ',vol.numero, ' ', vol.complemento, ', ', vol.bairro) AS 'Endereço', CONCAT(vol.cidade, ' - ', vol.estado) AS 'Cidade/UF' FROM tbusuarios AS usr INNER JOIN tbvoluntarios AS vol ON usr.codVol = vol.codVol;
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(12,'Feijao Carioca',12,1,'KG','1000000000012','2025-02-05','2026-02-01','2026-01-15',1);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(13,'Macarrao Parafuso',30,500,'G','1000000000013','2025-03-20','2025-12-31','2025-11-30',1);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(14,'Acucar Cristal',25,1,'KG','1000000000014','2025-04-12','2026-04-10','2026-03-05',1);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(15,'Oleo de Soja',40,900,'ML','1000000000015','2025-08-01','2026-07-20','2026-05-30',1);
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(46,'Cafe Torrado e Moido',12,500,'G','2000000000046','2025-11-01','2026-04-15','2026-03-01',2);
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(20,'Cafe Soluvel',16,200,'G','1000000000024','2025-06-09','2026-06-01','2026-04-15',2);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(21,'Achocolatado em PO',22,400,'G','1000000000025','2025-09-02','2026-08-20','2026-07-01',2);
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(23,'Oleo de Girassol',10,900,'ML','1000000000031','2025-02-28','2026-02-20','2026-01-31',3);
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(25,'Feijao Vermelho',9,1,'KG','1000000000033','2025-05-21','2026-05-15','2026-04-05',3);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(26,'Macarrao Instantaneo',80,85,'G','1000000000034','2025-07-30','2026-07-25','2026-06-10',3);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(27,'Extrato de Tomate',24,200,'G','1000000000035','2025-08-14','2026-08-10','2026-07-01',3);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(28,'Leite em PO',12,400,'G','1000000000036','2025-10-05','2026-09-30','2026-08-15',3);


-- Produtos da Fernanda Costa (codUsu = 4) -> codProd 29..34
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(29,'Sabao em PO',26,2,'KG','1000000000041','2025-01-30','2027-01-20','2026-12-01',4);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(30,'Detergente Liquido',40,500,'ML','1000000000042','2025-03-12','2026-03-05','2026-02-01',4);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(56,'Sabao em PO',16,2,'KG','2000000000056','2025-11-01','2027-01-01','2026-12-15',4);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(31,'Pasta de Dente',33,90,'G','1000000000043','2025-05-02','2027-05-01','2027-03-30',4);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(32,'Papel Higienico (4 unid)',18,0.5,'KG','1000000000044','2025-06-18','2028-06-01','2028-03-20',4);

INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(33,'Agua Mineral 1.5L',72,1.5,'L','1000000000045','2025-09-07','2027-09-01','2027-07-15',4);
...
INSERT INTO tbProdutos(codProd,nome,quantidade,peso,unidade,codBar,dataDeEntrada,dataDeValidade,dataLimiteDeSaida,codUsu)
VALUES(36,'Gelatina em PO',44,20,'G','1000000000052','2025-04-27','2026-04-20','2026-03-15',5);
